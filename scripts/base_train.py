...
parser.add_argument("--n-entities", type=int, default=0, help="entity slots for progressive injection (0=disabled)")
parser.add_argument("--scale0-cap", type=float, default=0.15, help="cap for inject_scales[0] in entity injection")
